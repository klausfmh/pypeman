...
The role of pypem plugins to insert plugins, which don't really make part of
the pypeman graph, but are intended for debugging, monitoring or any other
code, that shall be present along the pypeman code.
